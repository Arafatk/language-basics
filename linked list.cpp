...
void deleterNode(struct LNode **head_ref, int data);
...
/*
Learn the fucked pointer represenation of linked list and all that shit 
Along with avl tree and code these from memory
*/